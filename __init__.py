    ...
    *,
    ...
    async def async_startup():
        ...
        if cameraBase.hass.state == CoreState.running:
            ...
            cameraBase.hass.bus.async_listen_once(EVENT_HOMEASSISTANT_STARTED, cameraBase.startup_tasks)

        await cameraBase.async_set_stage(SetupStage.WAITING)
        cameraBase.log.info("Setup complete, waiting for Home Assistant before startup tasks starts")
