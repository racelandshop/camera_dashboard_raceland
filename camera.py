...
class GenericCamera(Camera):
    ...
    def __init__(self, hass, device_info):
        ...
        self._limit_refetch = device_info[CONF_LIMIT_REFETCH_TO_URL_CHANGE] #change these to .get with a standart value
    ...
    @property
    def unique_id(self):
        return f"{uuid_util.random_uuid_hex()}-{self._name}"
