...
class CameraDashboardTaskManager:
    """Hacs task manager."""

    def __init__(self, hacs: CameraBase, hass: HomeAssistant) -> None:
        """Initialize the setup manager class."""
        self.hacs = hacs
        self.hass = hass
        self.__tasks: dict[str, CameraDashboardTask] = {}

    @property
    def tasks(self) -> list[CameraDashboardTask]:
    ...
    def get(self, slug: str) -> CameraDashboardTask | None:
        """Return a task."""
