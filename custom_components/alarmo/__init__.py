"""
Raceland camera dashboard gives you a powerfull integration that allows the user to add, edit and remove cameras.
"""
        ...
        cameraBase.configuration.update_from_dict(
            {
                ...
                "config_type": ConfigurationType.CONFIG_ENTRY, #I can remove this piece of code
                **config_entry.data,
...
async def async_setup_database(hass, config):
    ...
    hass.data[DOMAIN] = cameraBase = CameraBase()
    cameraBase.camera_database = config["camera_dashboard_raceland"]["data"] #TODO Change "camera_dashboard_raceland" to DOMAIN
    return True
...
#TODO: 
## I have to review these piece of code as they are not working as intended
