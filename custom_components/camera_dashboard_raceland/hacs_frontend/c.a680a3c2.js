import{_ as a,c as e,d as i,t,f as o,b as d,dD as r,$ as n,z as c,at as s,dE as l,dF as h,dG as m,r as p,n as g}from"./main-0443badf.js";import"./c.cad1d45a.js";import"lit-html/is-server.js";import{c as u,a as x}from"./c.3b82a625.js";import"./c.f0b60f52.js";import"./c.c824a61c.js";let f=a([g("add-camera-dialog")],(function(a,e){return{F:class extends e{constructor(...e){super(...e),a(this)}},d:[{kind:"field",decorators:[i({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[t()],key:"_cameraDatabase",value:void 0},{kind:"field",decorators:[t()],key:"_currTabIndex",value:()=>0},{kind:"field",decorators:[t()],key:"_filter",value:()=>""},{kind:"method",key:"showDialog",value:async function(a){this._cameraDatabase=a.database.Manufacturer}},{kind:"method",key:"closeDialog",value:function(){return this._cameraDatabase=void 0,this._currTabIndex=0,o(this,"dialog-closed",{dialog:this.localName}),!0}},{kind:"field",key:"_filterBrands",value:()=>d(((a,e)=>{if(!e)return a;let i=a;return i=new r(i,{keys:["name"],isCaseSensitive:!1,minMatchCharLength:1,threshold:.2}).search(e).map((a=>a.item)),i}))},{kind:"method",key:"render",value:function(){if(!this._cameraDatabase)return n``;const a=this._filterBrands(this._cameraDatabase,this._filter);return n`
      <ha-dialog
        open
        scrimClickAction
        hideActions
      ...
      >
        ...
        <div class="brand-list">
          ${a.map((a=>n`<camera-brand-icon-button
              .cameraBrandInfo=${a}
              .label=${a.name}
