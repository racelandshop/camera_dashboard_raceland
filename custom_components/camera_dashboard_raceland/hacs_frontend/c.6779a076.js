import{ah as t,G as e,d as i,en as a,$ as s,z as o,Q as l,eo as r,r as n,_ as d,j as h,k as p,ep as u,n as c}from"./main-0443badf.js";import"lit-html/is-server.js";const m={fromAttribute:t=>null!==t&&(""===t||t),toAttribute:t=>"boolean"==typeof t?t?"":null:t};class x extends a{constructor(){super(...arguments),this.rows=2,this.cols=20,this.charCounter=!1}render(){const t=this.charCounter&&-1!==this.maxLength,e=t&&"internal"===this.charCounter,i=t&&!e,a=!!this.helper||!!this.validationMessage||i,l={"mdc-text-field--disabled":this.disabled,"mdc-text-field--no-label":!this.label,"mdc-text-field--filled":!this.outlined,"mdc-text-field--outlined":this.outlined,"mdc-text-field--end-aligned":this.endAligned,"mdc-text-field--with-internal-counter":e};return s`
    ...
    `]}]}}),x);const f=t=>`/local/brands/${t.domain}/icon.png`,b=t=>t.split("/")[4];export{f as b,b as e};
