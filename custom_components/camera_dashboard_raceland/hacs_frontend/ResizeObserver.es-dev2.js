...
return requestAnimationFrame.bind(global$1);}var result=function(callback){return setTimeout(function(){callback(+Date.now());},1000/60);};return result;}();// Defines minimum timeout before adding a trailing call.
...
if(!isBrowser||!this.connected_){return;}document.removeEventListener('transitionend',this.onTransitionEnd_);window.removeEventListener('resize',this.refresh);if(this.mutationsObserver_){this.mutationsObserver_.disconnect();if(origAttachShadow){HTMLElement.prototype.attachShadow=origAttachShadow;}}if(this.mutationEventsAdded_){document.removeEventListener('DOMSubtreeModified',this.refresh);}this.mutationsObserver_=null;this.mutationEventsAdded_=false;this.connected_=false;};/**
...
var isReflowProperty=transitionKeys.some(function(key){return !!~propertyName.indexOf(key);});if(isReflowProperty){this.refresh();}};/**
      ...
      */ResizeObserverController.getInstance=function(){if(!ResizeObserverController.instance_){ResizeObserverController.instance_=new ResizeObserverController();}return ResizeObserverController.instance_;};/**
 ...
 ***************************************************************************** */function __values(o){var m=typeof Symbol==="function"&&o[Symbol.iterator],i=0;if(m)return m.call(o);return {next:function(){if(o&&i>=o.length)o=void 0;return {value:o&&o[i++],done:!o};}};}/**
  ...
  */var defineConfigurable=function(target,props){var e_1,_a;try{for(var _b=__values(Object.keys(props)),_c=_b.next();!_c.done;_c=_b.next()){var key=_c.value;Object.defineProperty(target,key,{value:props[key],enumerable:false,writable:false,configurable:true});}}catch(e_1_1){e_1={error:e_1_1};}finally{try{if(_c&&!_c.done&&(_a=_b.return))_a.call(_b);}finally{if(e_1)throw e_1.error;}}return target;};/**
  * Returns the global object associated with provided element.
  *
  * @param {EventT} target
  * @returns {Object}
  */var getWindowOf=function(target){var _a;// Assume that the element is an instance of Node, which means that it
// has the "ownerDocument" property from which we can retrieve a
// corresponding global object.
// Return the local global object if it's not possible extract one from
// provided element.
return ((_a=target===null||target===void 0?void 0:target.ownerDocument)===null||_a===void 0?void 0:_a.defaultView)||global$1;};// Placeholder of an empty content rectangle.
var emptyRect=createRectInit(0,0,0,0);/**
  * Converts provided string to a number.
  */function toFloat(value){if(typeof value==='number'){return value;}return parseFloat(value)||0;}/**
  ...
  */function getPaddings(styles){var st=styles;return {top:toFloat(st['padding-top']),right:toFloat(st['padding-right']),bottom:toFloat(st['padding-bottom']),left:toFloat(st['padding-left'])};}/**
...
defineConfigurable(this,{target:target,contentRect:contentRect});}return ResizeObserverEntry;}();/**
  ...
  */ /* eslint-disable require-jsdoc, valid-jsdoc */var MapShim=function(){if(typeof Map!=='undefined'){return Map;}/**
      ...
      *
      * @param target Element to be observed.
      */ResizeObserverSPI.prototype.observe=function(target){if(target===undefined){throw new TypeError('1 argument required, but only 0 present.');}// Do nothing if current environment doesn't have the Element interface.
...
this.controller_.refresh();};/**
      ...
      */ResizeObserverSPI.prototype.unobserve=function(target){if(target===undefined){throw new TypeError('1 argument required, but only 0 present.');}// Do nothing if current environment doesn't have the Element interface.
...
var entries=this.activeObservations_.map(function(observation){return new ResizeObserverEntry(observation.target,observation.broadcastRect());});this.callback_.call(ctx,entries,ctx);this.clearActive();};/**
      ...
      */ResizeObserverSPI.prototype.hasActive=function(){return this.activeObservations_.length>0;};return ResizeObserverSPI;}();/**
