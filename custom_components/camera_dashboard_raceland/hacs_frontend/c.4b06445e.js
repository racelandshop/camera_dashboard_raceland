...
`,W=document.createElement("template");W.innerHTML=`<style>${U.toString().replace(":host","html")}</style>`,document.head.appendChild(W.content);const G=t`
  :host {
    top: 16px;
    right: 16px;
...
`,me=G;L("",me,{moduleId:"material-menu-overlay"});L("vaadin-combo-box-overlay",[me,t`
  :host {
