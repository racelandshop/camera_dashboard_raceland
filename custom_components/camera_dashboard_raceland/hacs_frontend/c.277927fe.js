import{N as e,_ as t,c as i,d as a,t as s,$ as o,j as n,k as r,b as d,f as l,eR as c,r as h,n as m,G as u,z as p,I as g,a5 as _,dF as v,eS as b,Q as f,K as y,o as k,eT as w,er as x,at as $,ax as I}from"./main-0443badf.js";import{a as z}from"./c.cad1d45a.js";import"lit-html/is-server.js";import{aW as O,a9 as C,ay as S,aX as D,aY as T,Q as H,a5 as j}from"./c.603f0acc.js";import{e as P}from"./c.60b82eb5.js";import{s as W,d as E}from"./c.039b4847.js";import{b as A,e as L}from"./c.6779a076.js";import{d as U}from"./c.1ded644c.js";import"./c.0f12f325.js";import{c as F}from"./c.d294c310.js";const R=(e,t)=>e.callWS({type:"media_source/browse_media",media_content_id:t}),V=e=>e.startsWith("media-source://media_source"),N=async(e,t,i)=>{const a=new FormData;a.append("media_content_id",t),a.append("file",i);const s=await e.fetchWithAuth("/api/media_source/local_source/upload",{method:"POST",body:a});if(413===s.status)throw new Error(`Uploaded file is too large (${i.name})`);if(200!==s.status)throw new Error("Unknown error");return s.json()},M=async(e,t)=>e.callWS({type:"media_source/local_source/remove",media_content_id:t});class B{constructor(t=!0){e(this,"_storage",{}),e(this,"_listeners",{}),t&&window.addEventListener("storage",(e=>{e.key&&this.hasKey(e.key)&&(this._storage[e.key]=e.newValue?JSON.parse(e.newValue):e.newValue,this._listeners[e.key]&&this._listeners[e.key].forEach((t=>t(e.oldValue?JSON.parse(e.oldValue):e.oldValue,this._storage[e.key]))))}))}addFromStorage(e){if(!this._storage[e]){const t=window.localStorage.getItem(e);t&&(this._storage[e]=JSON.parse(t))}}subscribeChanges(e,t){return this._listeners[e]?this._listeners[e].push(t):this._listeners[e]=[t],()=>{this.unsubscribeChanges(e,t)}}unsubscribeChanges(e,t){if(!(e in this._listeners))return;const i=this._listeners[e].indexOf(t);-1!==i&&this._listeners[e].splice(i,1)}hasKey(e){return e in this._storage}getValue(e){return this._storage[e]}setValue(e,t){this._storage[e]=t;try{window.localStorage.setItem(e,JSON.stringify(t))}catch(e){}}}const q=new B,G=(e,t,i=!0,a)=>s=>{const o=i?q:new B(!1),n=String(s.key);e=e||String(s.key);const r=s.initializer?s.initializer():void 0;o.addFromStorage(e);const d=()=>o.hasKey(e)?o.getValue(e):r;return{kind:"method",placement:"prototype",key:s.key,descriptor:{set(i){((i,a)=>{let n;t&&(n=d()),o.setValue(e,a),t&&i.requestUpdate(s.key,n)})(this,i)},get:()=>d(),enumerable:!0,configurable:!0},finisher(r){if(t&&i){const t=r.prototype.connectedCallback,i=r.prototype.disconnectedCallback;r.prototype.connectedCallback=function(){var i;t.call(this),this[`__unbsubLocalStorage${n}`]=(i=this,o.subscribeChanges(e,(e=>{i.requestUpdate(s.key,e)})))},r.prototype.disconnectedCallback=function(){i.call(this),this[`__unbsubLocalStorage${n}`]()}}t&&r.createProperty(s.key,{noAccessor:!0,...a})}}},K=e=>{const t=[];if(!e)return t;const i=new Set;for(const[a]of e.languages){if(i.has(a))continue;i.add(a);let e=a;if(a in O.translations)e=O.translations[a].nativeName;else{const[t,i]=a.split("-");t in O.translations&&(e=`${O.translations[t].nativeName}`,t.toLowerCase()!==i.toLowerCase()&&(e+=` (${i})`))}t.push([a,e])}return t.sort(((e,t)=>F(e[1],t[1])))},J=(e,t,i)=>{const a=[];if(!t)return a;for(const[s,o]of t.languages)s===e&&a.push([o,i(`ui.panel.media-browser.tts.gender_${o}`)||i(`ui.panel.config.cloud.account.tts.${o}`)||o]);return a.sort(((e,t)=>F(e[1],t[1])))};t([m("ha-browse-media-tts")],(function(e,t){class i extends t{constructor(...t){super(...t),e(this)}}return{F:i,d:[{kind:"field",decorators:[a()],key:"hass",value:void 0},{kind:"field",decorators:[a()],key:"item",value:void 0},{kind:"field",decorators:[a()],key:"action",value:void 0},{kind:"field",decorators:[s()],key:"_cloudDefaultOptions",value:void 0},{kind:"field",decorators:[s()],key:"_cloudOptions",value:void 0},{kind:"field",decorators:[s()],key:"_cloudTTSInfo",value:void 0},{kind:"field",decorators:[G("cloudTtsTryMessage",!0,!1)],key:"_message",value:void 0},{kind:"method",key:"render",value:function(){var e;return o`<ha-card>
    ...
    `:o``}},{kind:"method",key:"_manage",value:function(){var e,t;e=this,t={currentItem:this.currentItem,onClose:()=>l(this,"media-refresh")},l(e,"show-dialog",{dialogTag:"dialog-media-manage",dialogImport:()=>import("./c.f17d5b16.js"),dialogParams:t})}},{kind:"field",static:!0,key:"styles",value:()=>h`
    mwc-button {
