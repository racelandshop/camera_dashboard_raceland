import{_ as e,c as r,d as a,t,$ as i,eB as o,eC as s,ak as c,af as n,eD as l,er as d,et as h,z as g,bM as v,eE as p,ca as y,c8 as f,r as m,n as u}from"./main-0443badf.js";import"lit-html/is-server.js";import{f as b}from"./c.603f0acc.js";import{g as k,e as $,b as x}from"./c.6d46f0a1.js";import{ac as _}from"./c.449fa12b.js";import{S as w}from"./c.6c0b87be.js";import"./c.039b4847.js";import"./c.c13d4687.js";import"./c.da136530.js";import"./c.655d6539.js";import"./c.cad1d45a.js";import"./c.14628a02.js";import"./c.60b82eb5.js";import"./c.efb702cd.js";const M=238.76104;e([u("hui-energy-distribution-card")],(function(e,r){return{F:class extends r{constructor(...r){super(...r),e(this)}},d:[{kind:"field",decorators:[a({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[t()],key:"_config",value:void 0},{kind:"field",decorators:[t()],key:"_data",value:void 0},{kind:"field",key:"hassSubscribeRequiredHostProps",value:()=>["_config"]},{kind:"method",key:"setConfig",value:function(e){this._config=e}},{kind:"method",key:"hassSubscribe",value:function(){var e;return[k(this.hass,{key:null===(e=this._config)||void 0===e?void 0:e.collection_key}).subscribe((e=>{this._data=e}))]}},{kind:"method",key:"getCardSize",value:function(){return 3}},{kind:"method",key:"render",value:function(){var e,r;if(!this._config)return i``;if(!this._data)return i`${this.hass.localize("ui.panel.lovelace.cards.energy.loading")}`;const a=this._data.prefs,t=$(a),m=void 0!==t.solar,u=void 0!==t.battery,k=void 0!==t.gas,w=t.grid[0].flow_to.length>0,j=null!==(e=_(this._data.stats,t.grid[0].flow_from.map((e=>e.stat_energy_from))))&&void 0!==e?e:0;let z=null;var C;k&&(z=null!==(C=_(this._data.stats,t.gas.map((e=>e.stat_energy_from))))&&void 0!==C?C:0);let D=null;m&&(D=_(this._data.stats,t.solar.map((e=>e.stat_energy_from)))||0);let F=null,W=null;u&&(F=_(this._data.stats,t.battery.map((e=>e.stat_energy_to)))||0,W=_(this._data.stats,t.battery.map((e=>e.stat_energy_from)))||0);let P=null;w&&(P=_(this._data.stats,t.grid[0].flow_to.map((e=>e.stat_energy_to)))||0);let S=null;m&&(S=(D||0)-(P||0)-(F||0));let E=null,B=null;null!==S&&S<0&&(u&&(E=-1*S,E>j&&(B=Math.min(0,E-j),E=j)),S=0);let H=null;m&&u?(B||(B=Math.max(0,(P||0)-(D||0)-(F||0)-(E||0))),H=F-(E||0)):!m&&u&&(B=P);let R=null;u&&(R=(W||0)-(B||0));const q=Math.max(0,j-(E||0)),A=Math.max(0,q+(S||0)+(R||0));let O,T,V,Y,G;m&&(O=M*(S/A)),R&&(T=M*(R/A));let I="https://app.electricitymap.org";if(this._data.co2SignalEntity&&this._data.fossilEnergyConsumption){const e=Object.values(this._data.fossilEnergyConsumption).reduce(((e,r)=>e+r),0),r=this.hass.states[this._data.co2SignalEntity];if(null!=r&&r.attributes.country_code&&(I+=`/zone/${r.attributes.country_code}`),null!==e){let r;V=j-e,r=q!==j?e*(q/j):e,G=M*(r/A),Y=M-(O||0)-(T||0)-G}}const J=q+(S||0)+(P?P-(B||0):0)+(H||0)+(R||0)+(E||0)+(B||0);return i`
